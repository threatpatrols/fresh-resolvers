...
more-or-less good/strong; this is not perfect but serves the purpose here.
...
top-250 ipv4 addresses before passing them through `dnsvalidator`. This is done 
...
Our lists are autogenerated daily using a Github Action and are available in 
